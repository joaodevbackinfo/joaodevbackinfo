<div align="center">
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00D9FF,40:0057FF,100:7B2FFF&height=220&section=header&text=João%20Vítor%20Piagem&fontSize=46&fontColor=ffffff&fontAlignY=52&desc=Analista%20de%20TI%20•%20Back-End%20Developer%20•%20Sistemas%20de%20Informação&descAlignY=72&descSize=16&animation=fadeIn"/>
</div>

<div align="center">

![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=20&duration=2500&pause=800&color=00D9FF&center=true&vCenter=true&width=750&lines=⚡+Back-End+Developer+%7C+Analista+de+TI;🐘+PHP+%7C+Laravel+%7C+Python+%7C+Flask;⚛️+React+Native+%7C+Node.js+%7C+TypeScript;🐳+Docker+%7C+Firebase+%7C+Arduino;🎓+Bacharel+em+Sistemas+de+Informação;🚀+Construindo+o+futuro+com+código)
...
<img height="175" src="https://github-readme-stats.vercel.app/api?username=joaodevbackinfo&show_icons=true&theme=tokyonight&hide_border=true&count_private=true&title_color=00D9FF&icon_color=7B2FFF&text_color=c9d1d9&bg_color=0d1117"/>
<img height="175" src="https://github-readme-stats.vercel.app/api/top-langs/?username=joaodevbackinfo&layout=compact&theme=tokyonight&hide_border=true&title_color=00D9FF&text_color=c9d1d9&bg_color=0d1117&langs_count=8"/>
...
```typescript
const dev = {
  nome:       "João Vítor Piagem Pereira",
  cargo:      "Analista de TI · Back-End Developer",
  formacao:   "Bacharelado em Sistemas de Informação",
  local:      "Paraíso do Tocantins, TO 🇧🇷",

  backend:    ["PHP", "Laravel", "Python", "Flask", "Node.js", "C"],
  frontend:   ["JavaScript", "TypeScript", "React Native", "Tailwind CSS"],
  database:   ["MySQL", "SQLite", "Firebase"],
  devops:     ["Docker", "Git", "Linux"],
  hardware:   ["Arduino", "IoT"],

  atualmente: "Expandindo conhecimentos em arquitetura de software e cloud",
  objetivo:   "Construir sistemas robustos, escaláveis e bem estruturados",
  openTo:     ["Novas oportunidades", "Projetos desafiadores", "Colaborações"],
} as const;
```
...
[![LinkedIn](https://img.shields.io/badge/Vamos_nos_conectar!-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/joaovitorpiagem)

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:7B2FFF,50:0057FF,100:00D9FF&height=130&section=footer&animation=fadeIn"/>
